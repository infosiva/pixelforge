...
export function Spotlight({ className = '', fill = 'white' }: { className?: string; fill?: string }) {
  return (
    <svg className={['animate-spotlight pointer-events-none absolute z-[1] h-[169%] w-[138%] lg:w-[84%] opacity-0', className].join(' ')} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 3787 2842" fill="none">
      <g filter="url(#filter)">

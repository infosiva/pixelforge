...
export const metadata: Metadata = {
  ...
  description: "Privacy policy for PixelForge — how we collect, use and protect your data.",
  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-16 text-sm leading-relaxed">
      ...
      <Section title="1. Who We Are">
        <p>PixelForge (https://arcadeforge.app) is operated by an independent developer. AI arcade game builder — create and play browser games generated by AI instantly.</p>

...
export const metadata: Metadata = {
  title: "About | PixelForge",
  description: "About PixelForge — AI arcade game builder — create and play browser games generated by AI instantly.",
...
export default function AboutPage() {
  return (
    <main className="max-w-3xl mx-auto px-4 py-16 text-sm leading-relaxed">
      <h1 className="text-3xl font-bold mb-6">About PixelForge</h1>

      <section className="mb-8">
        <p className="text-base leading-7">AI arcade game builder — create and play browser games generated by AI instantly.</p>
      </section>

      <section className="mb-8">
        <h2 className="text-lg font-semibold mb-3">What We Offer</h2>
        <p>
          PixelForge is a free service built to make productivity more accessible through the power of artificial intelligence.
      ...
      <section className="mb-8">
        ...
        <p>
          PixelForge is supported by advertising through Google AdSense. Ads help us keep the service
